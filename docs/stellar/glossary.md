...
| Term | Definition |
|------|-----------|
| **Stellar SDK** | A software development kit providing tools and libraries to interact with the Stellar blockchain programmatically |
| **Transaction Envelope** | Structure holding transaction details, signatures, and metadata for submission to the Stellar network |
