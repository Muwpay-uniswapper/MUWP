...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { canClose?: boolean, overlay?: boolean, cousin?: React.ReactNode, title?: string }
>(({ className, children, canClose = true, overlay = true, title, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay className={cn("overflow-y-auto", overlay ? "bg-background" : "bg-transparent")}>
