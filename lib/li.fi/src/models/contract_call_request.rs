...
/// ContractCallRequest : Object defining instructions on how to perform a cross chain call
...
pub struct ContractCallRequest {
    ...
    #[serde(rename = "contractOutputsToken", skip_serializing_if = "Option::is_none")]
    pub contract_outputs_token: Option<String>,
...
impl ContractCallRequest {
    ...
    pub fn new(from_chain: f32, from_token: String, from_address: String, to_chain: f32, to_token: String, to_amount: String, to_contract_address: String, to_contract_call_data: String, to_contract_gas_limit: String) -> ContractCallRequest {
        ContractCallRequest {
            from_chain,
            from_token,
            from_address,
