    ...
    (props: ScopedProps<SliderRangeProps>, forwardedRef) => {
        ...
        if (valuesCount > 1) {
            if (props.index === 0) {
                ...
                offsetStart = percentages[props.index - 1];
            } else if (props.index) {
                offsetStart = percentages[props.index - 1];
            } else {
                offsetStart = Math.min(...percentages);
            }

            if (props.index === 0) {
                offsetEnd = 100 - percentages[0];
            } else if (props.index === valuesCount) {
                offsetEnd = 0;
            } else if (props.index) {
                offsetEnd = 100 - percentages[props.index];
            } else {
        ...
        return (
            <span
                style={{
                    ...
                    position: 'absolute',
                    [orientation.startEdge]: `calc(${percent}% + ${/* thumbInBoundsOffset */ 0}px)`,
                }}
            >
